...
<head>
    ...
    <title>S3X Security Scan Report - {{ target }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🔒 S3X Security Scan Report</h1>
        ...
        <div class="footer">
            <p>Generated by S3X (Security Scanning and Exploitation) on {{ timestamp }}</p>
...
def main():
    parser = argparse.ArgumentParser(description='Generate HTML/PDF reports from S3X scan results')
